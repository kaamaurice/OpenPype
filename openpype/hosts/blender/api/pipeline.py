...
INVENTORY_PATH = Path(PLUGINS_DIR, "inventory")
...
def install():
    ...
    register_inventory_action_path(INVENTORY_PATH.as_posix())
...
def uninstall():
    ...
    deregister_inventory_action_path(INVENTORY_PATH.as_posix())
