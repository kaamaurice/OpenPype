...
def shutdown_blender(*args):
    # By default changes to preferences are saved on exit, this can be toggled
...
#  add qshortcuts https://stackoverflow.com/questions/19845774/is-it-possible-to-use-an-underlined-letter-as-keyboard-shortcut-in-qt  # noqa: E501


class BlenderClosingDialog(QMessageBox):
    def __init__(self, parent):
        super().__init__(parent)  # , Qt.WindowCloseButtonHint | Qt.WindowSystemMenuHint | Qt.WindowTitleHint | Qt.WindowStaysOnTopHint)  # noqa: E501
