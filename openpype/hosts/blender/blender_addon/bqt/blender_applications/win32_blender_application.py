...
def get_class_name(hwnd):
    # returns "GHOST_WindowClass" for Blender and BlenderWindows
    # (e.g. Preferences),
...
def get_process_hwnds():
    # https://stackoverflow.com/questions/37501191/how-to-get-windows-window-names-with-ctypes-in-python  # noqa: E501
    ...
    if process_windows:
        ...
        if len(process_windows) > 1:
            for win in process_windows:
                # to get the main window, get the one with no parent window
                # (parent_hwnd == 0)
